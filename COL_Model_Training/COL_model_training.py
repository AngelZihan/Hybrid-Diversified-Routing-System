...
class LitClassifier(pl.LightningModule):
    def __init__(
        ...
        if self.use_tabular:
            ...
            self.ln4 = nn.Linear(2, 2)
            # Transformer model
            self.cls_proj = nn.Linear(2, 16)
...
if __name__ == "__main__":
    ...
    trainer = pl.Trainer(accelerator="gpu", devices=[6], max_epochs=20,
    ...
    # for epoch in [2, 4, 6, 8, 10]:
        checkpoint_path = f"./checkpoint/lightning_logs/version_{version}/checkpoints/epoch={epoch - 1}-*.ckpt"
